...
TEST_CASE("testing nullptr") {
    SUBCASE("Sort 1") {
        int a{3};
        int b{2};
        int c{1};
        sort_values(&a, &b, nullptr);
        CHECK(a == 2);
        CHECK(b == 3);
        CHECK(c == 1);
    }
    ...
    SUBCASE("Sort 7") {
        ...
        int b{2};
        int c{1};
        sort_values(nullptr, nullptr, nullptr);
        CHECK(a == 3);
        CHECK(b == 2);
        CHECK(c == 1);
    }
